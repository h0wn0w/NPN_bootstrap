<?php
    ...
    1 => "Unable to open the remote file by cURL library.\n"
         ...
         "unreachable3" => Array (
    0 => "  <br /><br /><span class='warnadmin sml'>
    ...
    1 => " Indexing of ZIP archives is not activated in Admin Settings.\n"
         ...
         "errorOpenPDF" => Array (
    0 => " <br />\n<span class='warnadmin'>Error opening this PDF file, perhaps because it is corrupted.<br />Unable to process this PDF document.<br /></span></section><br />\n",
    ...
    0 => " <br />\n<span class='warnadmin'>Error related to PDF permissions.<br /><br />Unable to process this PDF document.<br /></span></section><br />\n",
    ...
    1 => " Could not find PDF converter.\n"
         ...
         "ufoError" => Array (
    0 => " <br />\n<span class='warnadmin'> Unable to process this PDF document.<br /><br />Converter didn't pass back the ready status or any known error message.</span></section><br />\n",
    1 => " Unable to process this PDF document.\nConverter didn't pass back the ready status or any known error message. n"
    ),
         "nothingFound" => Array (
    0 => " <br />\n<span class='warnadmin'> Converter did not send any error message, but was unable to extract any word from this file.</span></section><br />\n",
    1 => " Converter did not send any error message, but was unable to extract any word from that file.\n"
    ),
         "jsEmpty" => Array (
    0 => " <br />\n<span class='warnadmin'> Nothing found to be indexed in this JavaScript.</span></section><br />\n",
    1 => " Nothing found to be indexed in this JavaScript.\n"
    ),
         "xlsError" => Array (
    0 => " <br />\n<span class='warnadmin'> EXEL reader was unable to extract any word from this file.</span></section><br />\n",
    1 => " EXELm reader was unable to extract any word from that file.\n"
    ),
         "outLimit" => Array (
    0 => " <br /><br />\n<span class='warnadmin'> Attention: Full text of this page is too large. Automatically limited to 16 MiB.</span><br />\n",
    1 => " Full text of this page is too large. Automatically limited to 16 MiB.\n"
    ),
          "noFollow" => Array (
    0 => " <span class='warnadmin'>No-follow flag set</span><br /></section><br />\n",
    1 => " No-follow flag set."
    ),
         "inDatabase" => Array (
    0 => "<br /><span class='warnadmin'>already in database</span> </section>\n",
    ...
    1 => "No Sql Server reconnected\n"
          ...
          "starting" => Array (
    0 => " <p class='alert'><span class='em'>Start indexing at %cur_time.</p><br />\n",
    ...
    1 => ""
         ...
         "pageRemoved" => Array (
    0 => "<br />\n	<span class='warnadmin'>Page removed from index</span><br /></section><br />\n",
    ...
    1 => " \r\n\r\nNew keywords found here:\n"
          ...
          "newLinks" => Array (
    0 => "	\n<span class='bd'>\n<br /><br />New links found here:<br /><br />\n</span>\n",
    ...
    1 => " \n Files found in archive: \n"
          ...
          "indexed1" => Array (
    0 => "<br /><span class='bd warnok'>\n<br />Indexed</span>\n",
    1 => "Indexed\r\n"
    ),
          "indexed" => Array (
    0 => "\n<br /><span class='bd warnok'><br />Indexed</span></section>\n",
    1 => "Indexed\r\n"
    ),
        "duplicate" => Array (
    0 => "<br /><span class='warnadmin'><br />Content of page is duplicate with:</span><br /><br /></section>\n",
    1 => " \nContent of page is duplicate with:\n"
    ),
        "md5notChanged" => Array (
    0 => "<br /><span class='warnadmin'>MD5 sum checked. Page content not changed.</span></section>\n",
    ...
    1 => " Link is unreachable.\n"
        ...
        "noCharset" => Array (
    0 => "<br /><span class=\"warnadmin\">Unable to detect the charset of this page or charset not available for code-converter.<br />Using home charset ($home_charset) as defined in Admin backend.</span><br /></section>\n",
    ...
    1 => " Also unable to detect the charset as defined in Admin settings. Content not converted to UTF-8.\n"
         ...
         "abortedIndx" => Array (
    0 => "<br />\n	<span class='warnadmin'><strong><center>Unable to proceed with indexing.&nbsp;&nbsp;Process aborted for this link.</center></stong></span><br /></section>\n",
    1 => " Unable to proceed with indexing. Process aborted for this link.\n"
    ),

        "notRSS" => Array (
    0 => "<br /><span class='warnadmin'>Currently unsupported XML file. No RDF, RSS or Atom tag detected here.</span><br /></section>\n",
    1 => " Currently unsupported XML file.  No RDF, RSD, RSS or Atom tag detected here.\n"
    ),
        "invalidRSS" => Array (
    0 => "<br /><span class='warnadmin'>Not a valid RDF, RSD, RSS or Atom feed for Sphider-plus.</span><br /></section>\n",
    1 => " Not a valid RDF, RSS or Atom feed for Sphider-plus. \n"
    ),
        "noWhitelist" => Array (
    0 => "<br /><span class='warnadmin'>Content ignored, as it did not match the whitelist.</span><br /></section>\n",
    1 => " Content ignored, as it did not match the whitelist.\n"
    ),
        "noDoclist" => Array (
    0 => "<br /><span class='warnadmin'>Content ignored, as it did not match the docs list.</span><br /></section>\n",
    1 => " Content ignored, as it did not match the docs list.\n"
    ),
        "matchBlacklist" => Array (
    0 => "<br /><span class='warnadmin'>Content ignored, as it met the blacklist.</span><br /></section>\n",
    1 => " Content ignored, as it met the blacklist.\n"
    ),
        "metaNoindex" => Array (
    0 => "<br /><span class='warnadmin'>No-Index flag set in meta tags.</span><br /></section>\n",
    1 => " No-Index flag set in meta tags.\n"
    ),
        "NoSitesFound" => Array (
    0 => "<br /><span class='warnadmin'>No sites stored in temporary file for this page.</span><br /></section>\n",
    ...
    1 => " Starting Link-check.\n"
        ...
        "link_okay" => Array (
    0 => "<br /><span class='warnok em'>Okay, page is available.</span></section><br />\n",
    ...
    1 => " Not checked, local link.\n"
        ...
        "minWords" => Array (
    0 => " <br /><span class='warnadmin'>Page contains less than $min_words_per_page words</span><br /></section><br />\n",
    1 => "\nPage contains less than $min_words_per_page words.\n"
    ),
        "js_content" => Array (
    0 => " <br /><span class='warnadmin'>Page contains only JavaScript, which is only indexed in order to find links.</span><br /></section><br />\n",
    ...
    function printRetrieving($num, $thislink, $cl) {
        ...
        if ($num & 1) {
            $log_msg_html = "	<section class='evrow sml'>\n";
        } else {
            $log_msg_html = "	<section class='odrow sml'>\n";
        }
    ...
    function printLinksReport($numoflinks, $all_links, $cl) {
        ...
        $log_msg_html = "\n<br /><br /><span class='bd'> Links found here: $all_links - New links: $numoflinks</span><br />\n";
        if ($no_log == '0') {
            if ($cl != 1) {
                print $log_msg_html;
            } else {
    ...
    function printHTMLHeader($omit, $url, $cl, $multi, $all, $started) {
        global $db_con, $log_format, $template_path, $copy, $plus_nr, $home_charset, $cn_seg, $no_log, $multi_indexer, $no_log, $admin_url, $template_url;

        error_reporting(E_ALL & ~E_DEPRECATED & ~E_WARNING & ~E_NOTICE & ~E_STRICT);

        if ($multi_indexer == 1 || $url) {   //  enter here if multi indexing is not activated or for single URL indexing
            $log_msg_html_0 = "<!DOCTYPE HTML>
    <head>
        <base href = $admin_url>
        <title>Sphider-plus v.$plus_nr index_log file</title>
        <meta charset='UTF-8'>
        <meta name='public' content='all'>
        <meta http-equiv='expires' content='0'>
        <meta http-equiv='pragma' content='no-cache'>
        <meta http-equiv='X-UA-Compatible' content='IE=9' />
        <link href='$template_url/html/sphider-plus.ico' rel='shortcut icon' type='image/x-icon' />
    ...
    <body>
        ...
        <div id='report'>
            <p class='evrow'><a class='bkbtn' href='admin.php' title='jump back to Sites view'><strong>Back to admin</strong></a>&nbsp;&nbsp;&nbsp;Abort immediately without caring about the consequences.</p>
            <br />
            <p class='evrow'><a class='bkbtn' href='admin.php?cancel=1' title='Abort and jump back to Admin'><strong>Cancel this index procedure</strong></a><br /><br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Database will be updated, repaired, optimized and flushed. Please remain patient, as it may take some time to work out all.</p>
            <br />
    ...
    <body>
        ...
        <div class='no_write'>
            ...
            <br /><br />
            <p class='evrow, cntr'>Start of next indexer will be offered immediately.</p>
        </div>
        <br /><br />
                    ";
    ...
    function printCountKeywords($count, $cl) {
        global $db_con, $log_format, $copy, $no_log;

        $log_msg_txt = "Amount of new keywords found here: $count\n";
        $log_msg_html = "<span class='bd'> Amount of new keywords found here: $count</span><br /><br /></section>\n";
        if ($no_log == '0') {
            if ($cl != 1) {
                print $log_msg_html;
            } else {
    ...
    function printWarning($report, $cl) {
        ...
        $log_msg_txt = "$report\n";
        $log_msg_html = " <span class='warnadmin'>$report</span><br /></section>\n";
        if ($no_log == '0') {
            if ($cl != 1) {
                print $log_msg_html;
            } else {
    ...
    function printWarning1($report, $cl) {
        global $db_con, $log_format, $copy, $no_log;
    ...
    function printCancel($report, $cl) {
        ...
        $log_msg_txt = "$report\n";
        $log_msg_html = "   <br /><br /><span class='warnadmin sml'>&nbsp;&nbsp;$report&nbsp;&nbsp;</span><br />\n";
        if ($no_log == '0') {
            if ($cl != 1) {
                print $log_msg_html;
            } else {
