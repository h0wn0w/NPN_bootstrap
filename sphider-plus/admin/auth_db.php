<?php
    ...
    (isset($_SESSION['db_admin']) && isset($_SESSION['db_admin_pw']) && crypt($_SESSION['db_admin'], $db_admin) == $db_admin && crypt($_SESSION['db_admin_pw'], $db_admin_pw) == $db_admin_pw ) || ($_SERVER['REMOTE_ADDR']=="")
    ) {
    } else {
