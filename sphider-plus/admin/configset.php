<?php
    ...
    $plus_nr        = '3.2015e';    // Sphider-plus version  (both required for first start up)
    $_plus_nr       = '3.2015e';    // Sphider-plus version  (both required for first start up)
...
*/
    ...
    if (stristr($os, "windows")) {
        $_op_system = 'win';
        $op_system  = 'win';
        $_catdoc_path = str_ireplace("pdftotext", "catdoc.exe", $pdftotext_path);
        $_catppt_path = str_ireplace("pdftotext", "catppt.exe", $pdftotext_path);
    }
...
*/
    ...
    if (isset($Submit)) {
        ...
        if (!is_writable("".$settings_dir."/db".$dba_act."/".$testfile."")) {
            ...
            fwrite($fhandle,"$"."real_log = ".substr(trim($real_log),0,1). ";");
            ...
            fwrite($fhandle,"$"."max_links = '".cleaninput(substr(trim($_max_links),0,6)). "';");
            ...
            fwrite($fhandle, "\n\n// Prevent queries for e-mail accounts\n");
            ...
            fwrite($fhandle,"$"."desc_length = ".cleaninput(substr(trim($_desc_length),0,5)). ";");
            ...
            fwrite($fhandle,"$"."whois_ext = ".substr(trim($_whois_ext),0,1). ";");
...
*/
                    ...
                    <tr>
                        <td width=\"50%\">
                            ...
                            <p>The following sections are available to configure Sphider-plus:</p>
                                <li>- <a href='admin.php?f=settings#set_1'>General Settings</a></li>
                                <li>- <a href='admin.php?f=settings#set_1a'>Admin Settings</a></li>
                                <li>- <a href='admin.php?f=settings#set_2'>Index Log Settings</a></li>
                                <li>- <a href='admin.php?f=settings#set_4'>Spider Settings</a></li>
                                <li>- <a href='admin.php?f=settings#set_5'>Search Settings</a></li>
                                <li>- <a href='admin.php?f=settings#set_6'>Suggestion Options</a></li>
                                <li>- <a href='admin.php?f=settings#set_7'>Page Indexing Weights</a></li>
                                <li>- <a href='new_authent.php?switch=settings'>Authentication for admin and database configuration</a></li>
                            </blockquote>
                        </td>
                        <td>
                            <blockquote>
    ...
    echo "
            />
            <p>&nbsp;</p>
            <label for='no_email'>Block all queries for e-mail accounts like 'my-name@gmail.com' :</label>
            <input name='_no_email' type='checkbox' id='no_email' value='1' title='Select, if you want to prevent queries like myname@gmail.com.'
        ";
    if ($no_email == 1) {
        echo " checked='checked'";
    }
