<?php
    ...
    include "commons.php";  //  process all common lists
...
";
    ...
    function cleaninput($input) {
        ...
        if ($no_email == 1) {
            if (preg_match("/\@|gmail|hotmail|yahoo|att|aol|1und1|1and1|email/i",$input)) {
                $input = '';
            }
        }
    ...
    class webshots {
        ...
        function __construct() {
            ...
            $this->api_url              = 'http://www.plsein.in/api/webshots';
