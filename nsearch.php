...
if (file_exists("$template_dir/$template/header_$language.html"))
  ...
  require_once("$template_dir/searchheader.html");*/
...
switch ($search) {
    case 1:
        ...
        require("$template_dir/search_results.html");
    break;
    default:
        if ($show_categories) {
            ...
            require("$template_dir/categories.html");
        }
    break;
    }
...
if (file_exists("$template_dir/$template/footer_$language.html"))
    ...
    require_once("$template_dir/searchfooter.html");
?>
