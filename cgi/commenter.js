...
function writeCommenterGreeting(){
	...
	content = '<p>To leave a comment, please sign in using your OpenID. If you don\'t have an OpenID, <a href="http://en.wikipedia.org/wiki/Openid">read about them here</a> and consider getting one (you may already have one without realizing it).</p> <form action="cgi/openid_send.cgi" method="PUT" > <img src="../../img/openid.png" style="border:0px;  background-color:transparent;margin:0px;padding:0px;"/><label for="openid-field">OpenID URL</label><input id="openid-field" type="text" name="openid" size="25"/><input type="submit" value="Login"/></form> '; 
		}
